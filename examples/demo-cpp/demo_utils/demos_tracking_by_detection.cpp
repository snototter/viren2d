...
void DemoBoundingBoxes2D() {
  ...
  painter->DrawBoundingBox2D(Rect::FromLTWH(50, 50, 100, 80, 0.2),
  ...
  painter->DrawBoundingBox2D(Rect::FromLTWH(50, 150, 100, 80, 0.2),
  ...
  style.label_position = label_positions[randmod(label_positions.size())];
  style.clip_label = true;
  painter->DrawBoundingBox2D(Rect::FromLTWH(50, 250, 100, 80, 0.2),
  ...
  style.label_position = label_positions[randmod(label_positions.size())];
  style.clip_label = false;
  painter->DrawBoundingBox2D(Rect::FromLTWH(50, 350, 100, 80, 0.2),
  ...
  style.label_position = label_positions[randmod(label_positions.size())];
  style.clip_label = true;
  painter->DrawBoundingBox2D(Rect::FromLTWH(50, 450, 100, 80, 0),
  ...
  painter->DrawBoundingBox2D(Rect::FromLTWH(200, 50, 100, 250, 0.4),
  ...
  style.text_fill_color = Color::Same.WithAlpha(0.3);
  style.label_position = label_positions[randmod(label_positions.size())];
  painter->DrawBoundingBox2D(Rect::FromLTWH(350, 50, 100, 250),
  ...
  style.label_position = label_positions[randmod(label_positions.size())];
  painter->DrawBoundingBox2D(Rect::FromLTWH(475, 50, 100, 250),
