...
painter.draw_text(
    text=['Hello World!'], position=(width/2, height/2), anchor='center',
...
painter.draw_marker(pt=(30, height/2), marker_style=marker_style)
painter.draw_marker(pt=(width - 30, height/2), marker_style=marker_style)
